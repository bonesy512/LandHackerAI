    ...
    <div className="container mx-auto max-w-4xl py-12 px-4">
      <Card className="w-full bg-card border-primary/20">
        ...
        <CardContent className="space-y-6">
          ...
          <div>
            <h3 className="text-2xl font-semibold mb-4 text-primary text-center">Meet the Team</h3>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              {/* Team Member 1 */}
              <div className="flex flex-col items-center text-center">
                <div className="w-24 h-24 rounded-full bg-muted mb-2" data-ai-hint="male headshot"></div>
